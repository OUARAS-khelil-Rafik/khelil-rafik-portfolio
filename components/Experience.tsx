...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-32 bg-dark overflow-hidden">
      <div className="container mx-auto px-6" ref={containerRef}>
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold font-display mt-2">{content.experience.title}</h2>
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          {items.map((item, index) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute left-[20px] md:left-1/2 w-4 h-4 bg-dark border-2 border-primary rounded-full transform -translate-x-1/2 mt-8 z-10 shadow-[0_0_10px_rgba(59,130,246,0.5)]">
                 <motion.div 
                    initial={{ scale: 0 }} 
                    whileInView={{ scale: 1 }}
              ...
              <div className={`md:w-1/2 pl-16 md:pl-0 ${index % 2 === 0 ? 'md:pr-16' : 'md:pl-16'}`}>
                <motion.div 
                    whileHover={{ y: -5 }}
                    className="bg-card p-8 rounded-2xl border border-slate-800 hover:border-slate-600 transition-all shadow-lg hover:shadow-xl relative group"
                >
                  ...
                  <h3 className="text-2xl font-bold text-white mb-1 font-display">{item.role}</h3>
